...
const AnimatedHero = () => {
  ...
  return (
    <div ref={heroRef} className="relative overflow-hidden bg-nexo-black bg-chrome-radial py-16 sm:py-24 bg-[size:20px_20px] bg-chrome-grid">
      ...
      <div className="nexo-container relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="absolute -right-16 -top-16 w-44 h-44 bg-nexo-blue/10 rounded-full blur-3xl animate-pulse"></div>
            <div className="absolute -left-16 -bottom-16 w-44 h-44 bg-nexo-blue/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
